...
import FaGraduation from 'react-icons/lib/fa/graduation-cap';
...
const navItems = [
  ...
  { to: '/table-siswa', name: 'siswa', exact: false, Icon: FaGraduation },
  { to: '#', name: 'pengajar', exact: false, Icon: FaUser },
            ...
            <NavItem
              ...
              <BSNavLink className={bem.e('nav-item-collapse')}>
                <div className="d-flex">
                  <FaDatabase className={bem.e('nav-item-icon')} />
