...
import { Helpers, VictorySharedEvents, VictoryContainer, VictoryTheme, PropTypes as CustomPropTypes } from "victory-core";
  ...
  _createClass(VictoryChart, [{
    ...
    value: function getNewChildren(props, childComponents, calculatedProps) {
      ...
      return children.map(function (child, index) {
        var childProps = _assign({ animate: getAnimationProps(props, child, index) }, child.props);
