...
exports.getBaseProps = exports.getStyles = exports.getScale = undefined;
...
var getScale = function (props) {
  var axis = _axis2.default.getAxis(props);
  var scale = _victoryCore.Scale.getBaseScale(props, axis);
  var domain = _axis2.default.getDomain(props, axis) || scale.domain();
...
var getAxisAngle = function (props) {
  ...
  var otherAxis = _axis2.default.getAxis(props) === "y" ? "x" : "y";
...
var getCalculatedValues = function (props) {
  props = (0, _assign3.default)({ polar: true }, props);
  ...
  var axis = _axis2.default.getAxis(props);
  var axisType = getAxisType(props);
  var stringTicks = _axis2.default.stringTicks(props) ? props.tickValues : undefined;
  var domain = _axis2.default.getDomain(props, axis);
  var range = getRange(props, axis);
