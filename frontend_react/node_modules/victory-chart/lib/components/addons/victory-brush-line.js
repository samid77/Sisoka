  ...
  return props.disable ? undefined : [{
    ...
    eventHandlers: {
      onMouseEnter: function (evt, targetProps) {
        ...
        return [{
          mutation: function () {
            return { activeBrushes: activeBrushes, brushDomain: targetProps.brushDomain, parentSVG: parentSVG };
          }
        }];
      },
          ...
          return [{
            mutation: function () {
              return {
                ...
                brushDomain: currentDomain, activeBrushes: activeBrushes, parentSVG: parentSVG
              };
            }
          }];
        } else {
          ...
          return allowDraw ? [{
            mutation: function () {
              return {
                ...
                activeBrushes: activeBrushes, parentSVG: parentSVG
              };
            }
          }] : [];
        }
      ...
      onMouseMove: function (evt, targetProps) {
        ...
        if (!targetProps.isPanning && !targetProps.isSelecting) {
          return [{
            mutation: function () {
              return {
                activeBrushes: activeBrushes, brushDomain: targetProps.brushDomain, parentSVG: parentSVG
              };
            }
          }];
        }
        if (allowDrag && isPanning) {
          ...
          var mutatedProps = {
            ...
            activeBrushes: { brush: true }, parentSVG: parentSVG
          };
          ...
          var _mutatedProps = {
            ...
            isSelecting: isSelecting, activeHandle: handle, parentSVG: parentSVG,
            activeBrushes: {
