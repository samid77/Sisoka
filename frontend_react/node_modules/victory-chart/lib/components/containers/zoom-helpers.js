...
var Helpers = {
  ...
  onMouseDown: function (evt, targetProps) {
    ...
    return [{
      ...
      mutation: function () {
        return {
          startX: x, startY: y, panning: true, parentSVG: parentSVG,
  ...
  onMouseMove: function (evt, targetProps, eventKey, ctx) {
    ...
    if (targetProps.panning && targetProps.allowPan) {
      ...
      var mutatedProps = {
        parentControlledProps: ["domain"], startX: x, startY: y, parentSVG: parentSVG,
...
exports.default = {
  ...
  onWheel: (0, _throttle3.default)(Helpers.onWheel.bind(Helpers), 16, // eslint-disable-line no-magic-numbers
  { leading: true, trailing: false })
};