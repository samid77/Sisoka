...
var BaseProps = exports.BaseProps = {
  ...
  maxDomain: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.instanceOf(Date), _propTypes2.default.shape({
    x: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.instanceOf(Date)]),
    y: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.instanceOf(Date)])
  })]),
  minDomain: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.instanceOf(Date), _propTypes2.default.shape({
    x: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.instanceOf(Date)]),
    y: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.instanceOf(Date)])
  })]),
  ...
  singleQuadrantDomainPadding: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.shape({
    x: _propTypes2.default.oneOfType([_propTypes2.default.bool]), y: _propTypes2.default.oneOfType([_propTypes2.default.bool])
  })]),
