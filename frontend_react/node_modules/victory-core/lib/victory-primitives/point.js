...
var Point = function (_React$Component) {
  ...
  _createClass(Point, [{
    ...
    value: function render() {
      ...
      return _react2.default.cloneElement(pathComponent, { style: style, role: role, shapeRendering: shapeRendering, className: className, events: events, d: d, transform: transform });
    }
  }]);
