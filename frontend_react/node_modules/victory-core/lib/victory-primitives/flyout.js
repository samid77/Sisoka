...
var Flyout = function (_React$Component) {
  ...
  _createClass(Flyout, [{
    ...
    value: function render() {
      ...
      return _react2.default.cloneElement(pathComponent, { style: style, className: className, shapeRendering: shapeRendering, role: role, events: events, transform: transform, d: path });
    }
  }]);
