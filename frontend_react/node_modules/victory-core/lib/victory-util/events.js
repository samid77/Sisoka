...
var _assign6 = require("lodash/assign");
...
exports.default = {
  ...
  getEvents: function (props, target, eventKey, getScopedEvents) {
    ...
    var getEventsByTarget = function (events) {
      ...
      return Array.isArray(selectedEvents) && selectedEvents.reduce(function (memo, event) {
        return event ? (0, _assign7.default)(memo, event.eventHandlers) : memo;
      }, {});
    };
    ...
    return (0, _assign7.default)({}, sharedEvents, ownEvents);
  },
  ...
  getScopedEvents: function (events, namespace, childType, baseProps) {
    ...
    var parseEvent = function (eventReturn, eventKey) {
      ...
      var getMutationObject = function (key, childName) {
        ...
        var mutatedProps = eventReturn.mutation((0, _assign7.default)({}, mutationTargetProps, mutationTargetState), baseProps);
        ...
        var extendState = function (state) {
          return target === "parent" ? (0, _assign7.default)(state, _defineProperty({}, key, (0, _assign7.default)(state[key], mutatedProps))) : (0, _assign7.default)(state, _defineProperty({}, key, (0, _assign7.default)(state[key], _defineProperty({}, target, mutatedProps))));
        };
        ...
        return childName !== undefined && childName !== null ? (0, _assign7.default)(baseState, _defineProperty({}, childName, updateState(childState))) : updateState(baseState);
      };
      ...
      var getReturnByChild = function (childName) {
        ...
        return Array.isArray(mutationKeys) ? mutationKeys.reduce(function (memo, key) {
          return (0, _assign7.default)(memo, getMutationObject(key, childName));
      ...
      return Array.isArray(allChildNames) ? allChildNames.reduce(function (memo, childName) {
        return (0, _assign7.default)(memo, getReturnByChild(childName));
    ...
    var parseEventReturn = function (eventReturn, eventKey) {
      return Array.isArray(eventReturn) ? eventReturn.reduce(function (memo, props) {
        memo = (0, _assign7.default)({}, memo, parseEvent(props, eventKey));
        return memo;
  ...
  getExternalMutations: function (mutations, baseProps, baseState, childName) {
    ...
    return eventKeys.reduce(function (memo, eventKey) {
      ...
      if (eventKey === "parent") {
        ...
        memo[eventKey] = mutation !== undefined ? (0, _assign7.default)({}, keyState, mutation) : keyState;
      } else {
        ...
        memo[eventKey] = targets.reduce(function (m, target) {
          ...
          m[target] = mutation !== undefined ? (0, _assign7.default)({}, keyState[target], mutation) : keyState[target];
  ...
  getExternalMutation: function (mutations, baseProps, baseState, identifier) {
    ...
    return keyMutations.reduce(function (memo, curr) {
      ...
      var currentMutation = mutationFunction((0, _assign7.default)({}, baseProps, baseState));
      return (0, _assign7.default)({}, memo, currentMutation);
    }, {});
  },
