...
CREATE TABLE `data_guru` (
  ...
  `pengalaman_kerja` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'Tidak Ada',
...
INSERT INTO `data_guru` (`id`, `nama_lengkap`, `NIP`, `tempat_lahir`, `tanggal_lahir`, `agama_id`, `jenis_kelamin`, `gelar`, `jabatan`, `pengalaman_kerja`, `alamat`, `nomor_telp`) VALUES
(1,	'Siti Badriyah',	'1306444491',	'Jakarta',	'1984-02-11',	1,	'Wanita',	'S.Pd',	'Guru',	'5 tahun mengajar di SD Bunda Kandung',	'Jalan Kalibata Indah',	'08128543822'),
(2,	'Miftahul Alam',	'1306454391',	'Kediri',	'1977-01-21',	1,	'Pria',	'S.Pd',	'Guru',	'Tidak Ada',	'Jalan Jenderal Ahmad Yani',	'08123849320'),
(3,	'Nur Santaria',	'1302744487',	'Medan',	'1988-07-24',	2,	'Wanita',	'S.Pd',	'Guru',	'Tidak Ada',	'Jalan Ancol',	'08137283927'),
(4,	'Jonathan Christianto',	'1475444823',	'Palembang',	'1993-08-20',	3,	'Pria',	'S.Pd',	'Guru',	'Tidak Ada',	'Jalan Pancoran Mas',	'08438201823'),
(5,	'Ade Putra',	'1421283491',	'Riau',	'0000-00-00',	4,	'Pria',	'S.Pd',	'Guru',	'Tidak Ada',	'Jalan Palmerah',	'08238291822'),
(6,	'Lisa Khairunnisa',	'1323817231',	'Jakarta',	'1988-04-11',	1,	'Wanita',	'S.Pd',	'Guru',	'Tidak Ada',	'Jalan Haji Naim',	'08372837199'),
(7,	'Putri Mayangsari',	'1271428411',	'Jombang',	'1982-09-11',	1,	'Wanita',	'S.Pd',	'Guru',	'Tidak Ada',	'Jalan Mampang',	'08192381922'),
(8,	'Vincent Wardhana',	'1825344211',	'Jakarta',	'1995-08-01',	2,	'Pria',	'S.Pd',	'Guru',	'Tidak Ada',	'Jalan Palmerah',	'08132839200'),
(9,	'Angelita Wisaputra',	'1881442331',	'Solo',	'1997-02-10',	3,	'Wanita',	'S.Pd',	'Guru',	'Tidak Ada',	'Jalan Sudirman',	'08238291022'),
(10,	'Willy Jodhi Sangkala',	'1321344821',	'Bandung',	'1988-11-02',	1,	'Pria',	'S.Pd',	'Guru',	'Tidak Ada',	'Jalan Kebagusan',	'08123829112');
